...
faq:
  - q: "Quem é o João Gabriel Melo Aiello?"
    a: "É um personagem de humor criado e interpretado pelo ator Matheus Aiello, conhecido nas redes pelo perfil @aielloflow. Não é um cientista real."
  - q: "O QI de 640 é verdadeiro?"
    a: "Não. Os testes de inteligência têm média 100 e desvio padrão de 15 pontos; 640 estaria a 36 desvios padrão da média, uma região da curva onde não existe população nem instrumento de medição calibrado."
  - q: "Ele tem mesmo 37 PhDs?"
    a: "Não. Um doutorado leva em média de quatro a seis anos após a graduação, e boa parte é presencial. Trinta e sete deles exigiriam mais de um século de dedicação exclusiva."
  - q: "Por que tanta gente acreditou?"
    a: "Porque recortes dos vídeos circularam sem indicação de que eram humor, e portais republicaram as alegações em formato de notícia. A checagem do Boatos.org classificou as alegações como falsas."
---
